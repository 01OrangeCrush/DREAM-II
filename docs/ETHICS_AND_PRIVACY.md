...
This repository must be maintained consistently with the approved research protocol and institutional requirements.

## Human-participant protections

Faculty evaluator participation is voluntary. Public releases must not identify or rank individual evaluators. Coded reviewer letters should be used in analytic files.
...
- copyrighted artifacts without redistribution permission.
